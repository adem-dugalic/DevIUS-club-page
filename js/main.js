...
var contact = document.querySelector(".regForm");
...
$(window).on("load", function () {
  ...
  img1.src = "img/try.jpg";
  img2.src = "img/projects.jpg";
  img3.src = "img/competitions.jpg";
  img4.src = "img/newBck.jpg";
});
...
aboutBtn.addEventListener("click", function () {
  ...
  about.style.display = "";
  education.style.display = "none";
  navigation.style.background = "rgb(64, 63, 63, 0.8)";
...
homeBtn.addEventListener("click", function () {
  ...
  about.style.display = "none";
  education.style.display = "none";
  //content.style.background = 'linear-gradient(19deg, #21D4FD 0%, #B721FF 100%)';
  work.style.display = "none";
  skills.style.display = "none";
  contact.style.display = "none";
});
eduBtn.addEventListener("click", function () {
  ...
  content.style.backgroundImage = "url(" + img1.src + ")";
  //content.style.backgroundPosition = "center";
  content.style.backgroundSize = "cover";
  content.style.backgroundRepeat = "no-repeat";
  navigation.style.background = "";
...
workBtn.addEventListener("click", function () {
  ...
  content.style.backgroundImage = "url(" + img2.src + ")";
  content.style.backgroundPosition = "center";
  content.style.backgroundSize = "cover";
  content.style.backgroundRepeat = "no-repeat";
  navigation.style.background = "rgb(64, 63, 63, 0.6)";
  home.style.display = "none";
  about.style.display = "none";
  education.style.display = "none";
  work.style.display = "";
...
skillsBtn.addEventListener("click", function () {
  ...
  content.style.backgroundImage = "url(" + img3.src + ")";
  content.style.backgroundPosition = "center";
  content.style.backgroundSize = "cover";
  content.style.backgroundRepeat = "no-repeat";
  navigation.style.background = "rgb(64, 63, 63, 0.4)";
  home.style.display = "none";
  about.style.display = "none";
  education.style.display = "none";
  work.style.display = "none";
    ...
    for (let b = a; b < particlesArray.length; b++) {
      ...
      if (distance < (canvas.width / 7) * (canvas.height / 7)) {
        ...
        if (mouseDistance < 180) {
          ctx.strokeStyle = "rgba(255,0,0," + opacityValue1 + ")";
        } else {
          ctx.strokeStyle = "rgba(0,0,255," + opacityValue1 + ")";
        }
        ctx.lineWidth = 1;
        ctx.beginPath();
